  ...
  return (
    <section id="circle" ref={ref} className="circle-section" style={{
      ...
      <h2 style={{
        ...
        Become part of<br />
        the <em style={{ fontStyle: 'italic', color: '#3D63B8' }}>ecosystem.</em>
      </h2>
      ...
      {joined ? (
        <p aria-live="polite" style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.5rem', fontStyle: 'italic', color: '#3D63B8' }}>
      ...
      <footer style={{
        ...
        <div>
          <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.3rem', fontWeight: 600, color: '#0C1023', marginBottom: '0.75rem' }}>
            Claude<span style={{ color: '#3D63B8' }}>Card</span>
          </div>
        ...
        <div>
          <p style={{ fontSize: '0.68rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#3D63B8', marginBottom: '1.25rem' }}>Worlds</p>
          {worlds.map(w => (
        ...
        <div>
          <p style={{ fontSize: '0.68rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#3D63B8', marginBottom: '1.25rem' }}>Ecosystem</p>
          {ecosystem.map(e => (
            <a key={e} href={e === 'Rewards Circle' ? '#rewards' : e === 'About Claude' ? '#about' : '#circle'} style={{ display: 'block', fontSize: '0.82rem', color: '#68748E', textDecoration: 'none', marginBottom: '0.6rem' }}>{e}</a>
          ))}
        </div>

        <div>
          <p style={{ fontSize: '0.68rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#3D63B8', marginBottom: '1.25rem' }}>Connect</p>
          {social.map(s => (
