...
export function Signup() {
  ...
  async function handleForgot() {
    ...
    setStatus('loading');
    await supabase.auth.resetPasswordForEmail(email, { redirectTo: 'https://claudecard.pro' });
    ...
    <>
      <footer style={{
        ...
        <div>
          ...
          <a href="/accessibility" style={{ display: 'block', fontSize: '0.82rem', color: '#68748E', textDecoration: 'none', marginBottom: '0.6rem' }}>Accessibility</a>
        </div>
      </footer>
      <div style={{
